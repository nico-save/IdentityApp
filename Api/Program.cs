...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        ...
        {
            // validate the token based on the key provided inside appsettings.dev JWT:Key
...
builder.Services.AddAuthorization(opt =>
{
    ...
    opt.AddPolicy("ManagerEmailAndWilsonSurnamePolicy", policy => policy.RequireClaim(ClaimTypes.Surname, "wilson").RequireClaim(ClaimTypes.Email, "manager@example.com"));
